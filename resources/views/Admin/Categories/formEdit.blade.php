        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card card-primary col-sm-12">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form action="{{ route('categories.edit', ['id'=>$idEdit]) }}" method="post" class="dropzone" id="dropzone" enctype="multipart/form-data">
                        @csrf
                        @method("post")
                        ...
                        <div class="card-footer">
                            ...
                            <button type="submit" class="btn btn-primary" id="btn-submit-loca" >Cập nhật danh mục</button>
                        </div>
