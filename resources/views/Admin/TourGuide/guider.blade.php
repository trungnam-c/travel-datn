    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12">
                ...
                <p class="alert alert-danger">{!! \Session::get('errorDelete') !!}</p>
                @endif
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><a href="{{ route('guider.form_add') }}"
                                class="btn btn-block btn-primary">Thêm hướng dẫn viên</a></h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr class="location-tr">
                                    ...
                                    <td>
                                        <p class="edit-p">
                                            <a href="{{ route('guider.edit', ['id'=>$row->id]) }}"><span
                                                    class="edit-span" alt="Chỉnh sửa dòng này"><i
                                                        class="bi bi-pencil-square"></i></span></a>
                                            --
                                            <a class="delete"
                                                href="{{ route('guider.delete', ['id'=>$row->id]) }}"><span
