                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="idlocation" id="idlocation" class="form-control select2bs4">
                                                ...
                                                @foreach ($location as $r)
                                                    <option value="{{$r->id}}">Đi: {{$r->diemdi}} | Đến: {{$r->diemden}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="form-group">
                                            <label for="ngaykhoihanh">Ngày khởi hành</label>
                                            <input type="date" class="form-control" id="ngaykhoihanh" name="ngaykhoihanh" min="2022-02-01">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="giokhoihanh" name="giokhoihanh" placeholder="14h50">
                                        </div>
                                        <div class="form-group">
                                            <label for="socho">Số chỗ</label>
                                            <input type="number" class="form-control" min="0" id="socho" name="socho" placeholder="Số chỗ ngồi"
