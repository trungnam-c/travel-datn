...
@section('web-title', 'Sửa mã giảm giá')
@section('main')
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{$data->magiamgia}}" id="magiamgia" name="magiamgia" disabled placeholder="">
                                </div>
                                <div class="form-group">
                                    <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                                        <label for="example">Ngày bắt đầu</label>
                                        <i class="fas fa-calendar input-prefix"></i>
                                        <input placeholder="Select date" type="date" value="{{date('Y-m-d',strtotime($data->ngaybatdau))}}" id="ngaybatdau" name="ngaybatdau" class="form-control">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="form-group">
                                    <div id="date-picker-example" class="md-form md-outline input-with-post-icon datepicker" inline="true">
                                        ...
                                        <input placeholder="Select date" type="date" value="{{date('Y-m-d',strtotime($data->ngayketthuc))}}" id="ngayketthuc" name="ngayketthuc" class="form-control">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="giatri" value="{{$data->giatri}}" name="giatri" placeholder="" disabled>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="loaima" value="{{$data->loaima == 1 ? 'giảm theo tiền' : 'giảm theo phần trăm'}}" name="loaima" placeholder="" disabled>
                                </div>
                            </div>
